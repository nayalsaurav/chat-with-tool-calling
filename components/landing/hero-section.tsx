          ...
          <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
            <div className="relative z-10 mx-auto max-w-2xl text-center">
              <h1 className="text-balance text-4xl font-semibold md:text-5xl lg:text-6xl">
                Your AI assistant,{" "}
                <span className="text-primary">ready to help</span>
              </h1>
              <p className="mx-auto my-8 max-w-2xl text-xl text-muted-foreground">
                Get real-time answers with live weather, F1 races, stock prices,
                and more — all through a simple conversation powered by AI tool
                calling.
              </p>
